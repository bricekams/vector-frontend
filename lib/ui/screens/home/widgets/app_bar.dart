...
class _HomeAppBarState extends State<HomeAppBar> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        ...
        trailing:
            context.watch<AugmentProvider>().augmentations.isNotEmpty &&
  ...
  _buildCounterZone() {
    bool hasAugmentations =
        context.watch<AugmentProvider>().augmentations.isNotEmpty;
    if (!hasAugmentations) {
      return null;
    }
    Augmentation? lastAugmentation =
        context.watch<AugmentProvider>().augmentations.last;
          ...
          child: Center(
            child: Text(
              context
                  ...
                  .augmentations
                  .where((e) => e.state == AugmentationState.uploading)
                  .length
                  .toString(),
